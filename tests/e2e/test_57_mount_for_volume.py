import subprocess
import os
from helpers import wait_for, check_containers_up, check_service_response, remove_build_context_from_docker_compose

def test_mount_for_volume_operations(test_env):
    ...
    remove_build_context_from_docker_compose(test_env.project_dir / "docker-compose.yml")
    ...
    # TODO: test both: build and volumes
