...
func (_m *MockDirEntry) Info() (FileInfo, error) {
	...
	var r0 FileInfo
	var r1 error
	if rf, ok := ret.Get(0).(func() (FileInfo, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() FileInfo); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockDirEntry_Info_Call) Return(_a0 FileInfo, _a1 error) *MockDirEntry_Info_Call {
...
func (_c *MockDirEntry_Type_Call) Return(_a0 iofs.FileMode) *MockDirEntry_Type_Call {
	_c.Call.Return(_a0)
	return _c
}
